        ...
        <div className="min-h-screen grid lg:grid-cols-2">
            <div className="flex flex-col justify-center p-8 sm:p-12 md:p-16 relative">
                <div className="absolute top-8 left-8 flex items-center gap-2">
                    ...
                    <span className="font-bold text-xl">ML Core</span>
                </div>

                <div className="mx-auto w-full max-w-md space-y-6">
                    <div className="space-y-2 text-center">
                        <h1 className="text-3xl font-bold tracking-tight">Welcome to ML Core</h1>
                        <p className="text-muted-foreground">Manage datasets and train models with ease.</p>
                    </div>
