		...
		<div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
			...
			<div>
				...
				<p className="text-muted-foreground mt-1">
					...
					— here's your ML platform overview.
				</p>
			</div>
						...
						<div className="flex items-center justify-between">
							<div>
								...
								<CardDescription className="text-xs">
									Models trained & datasets added over time
								</CardDescription>
							</div>
								...
								>
									<defs>
										...
										>
											<stop
												offset="5%"
												stopColor={CHART_COLORS.datasets}
												stopOpacity={0.3}
											/>
											<stop
												offset="95%"
									...
									<Area
										...
										dataKey="datasets"
										name="Datasets"
										stroke={CHART_COLORS.datasets}
										fill="url(#gradDatasets)"
										strokeWidth={2}
										dot={false}
									/>
								</AreaChart>
					...
					<CardHeader className="pb-2">
						<div className="flex items-center justify-between">
							<div>
								...
								<CardDescription className="text-xs">
									Average accuracy per training session
								</CardDescription>
							</div>
								...
								{stats.recent_models.map((m) => (
									...
									>
										...
										<div className="flex items-center gap-2 shrink-0 ml-2">
											<span
												className={`text-sm font-bold ${m.accuracy >= 80 ? "text-emerald-400" : m.accuracy >= 60 ? "text-amber-400" : "text-red-400"}`}
											>
												{m.accuracy}%
											</span>
											<Badge
